(function () {
    ...
    d3v3.layout.force = function () {
        ...
        force.drag = function () {
            if (!drag) drag = d3v3.behavior.drag()
                .origin(Object)
    ...
    function d3_layout_forceDrag() {
        d3_layout_forceDragNode.px = d3v3.event.x;
        d3_layout_forceDragNode.py = d3v3.event.y;
    ...
    function d3_layout_hierarchyRebind(object, hierarchy) {
        object.sort = d3v3.rebind(object, hierarchy.sort);
        object.children = d3v3.rebind(object, hierarchy.children);
        object.links = d3_layout_hierarchyLinks;
        object.value = d3v3.rebind(object, hierarchy.value);
