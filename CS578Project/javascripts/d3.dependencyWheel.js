...
d3.chart.dependencyWheel = function(options) {
  ...
  function chart(selection) {
    selection.each(function(data) {
      ...
      var nPackages=packageNames.length;
      // create the layout
      var chord = d3.chord()
        .padAngle(padding)
      ...
      var fill = function(d) {
        if (d.index === 0) return '#FFA500';  
        var v=packageNames[d.index].split(".");
        var l=v.length-1;
        return "hsl(" + parseInt(((v[l].charCodeAt() - 97) / 26) * 360, 10) + ",90%,70%)";
      };
      ...
      g.append("svg:text")
        ...
        .style("font-size",function(d){
          var textSize="35px";
          if(nPackages>10)  textSize="20px";
          if(nPackages>50)  textSize="15px";
          if(nPackages>100)  textSize="10px"; 
          if(nPackages>150)  textSize="6px";
          return d.value==0?"6px":textSize;
      })
        .attr("size","2")
